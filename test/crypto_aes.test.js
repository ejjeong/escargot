...
function AESEncryptCtr(plaintext, password, nBits) {
  ...
  var nonce = 2;// (new Date()).getTime();  // milliseconds since 1-Jan-1970
...
function unescCtrlChars(str) {  // unescape potentially problematic control characters
  ...
  print("-------------");
  var ret = str.replace(/!\d\d?\d?!/g, function(c) { return String.fromCharCode(c.slice(1,-1)); });
  for (var i =0; i< ret.length; i++)
    print(ret.charCodeAt(i));
  print("==============");
  return ret;
}
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
