...
[
    ...
    },
    {
        ...
        {
            var one = 1;
            assert.throws(function() { "use strict"; one.a = 1; }, TypeError, "Assigning to a property of a number should throw a TypeError.", "Attempted to assign to readonly property.");
        }
    },
    {
        name: "Assignment to a property on a number without a setter in sloppy mode should be ignored",
    ...
    },
    {
        ...
        {
            var one = 1;
            assert.throws(function() { "use strict"; one[66] = 1; }, TypeError, "Assigning to a property of a number should throw a TypeError.", "Attempted to assign to readonly property.");
        }
    },
];
