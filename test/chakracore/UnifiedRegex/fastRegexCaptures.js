...
exec(/.*(aaa.*aaa)/, "aaaaaa");
exec(/.*a(.*aaa.*)a.*/, "aaaaa");
exec(/.*(\.facebook\..*)/, "www.facebook.com");
exec(/.*(aamber aamber aamber)/, "aamber aamber aamber.");
exec(/.*(this (is this is) this)/, "this is this is this");
exec(/.*(this is top tier toy)/, "this is top tier toy");
