...
match(/a*/g, "aaabbaababab");
match(/a+/g, "aaabbaababab");
match(/a{2,3}$/g, "aaabbaababaa");
match(/^a{3,12}/g, "aaabbaababaa");
match(/a{4,12}/g, "aaabbaababaa");
match(/^[ab]{12,20}$/g, "aaabbaababaa");
match(/^(?:a|b){12,20}$/g, "aaabbaababaa");
match(/^a|[ab]{12,20}$/g, "aaabbaababaa");
match(/^[ab]{13,20}$/, "aaabbaababaa");
r = /a*/g;
s = "cdsddfs";
exec(r, s);
exec(r, s);
...
match(/^a*$/gm, "bbb\nbaa\naaa\naaaab");
match(/a*b*a/g, "abbba");
match(/a*b*a$/g, "abbbabbbba");
match(/b*a/g, "abbbcbba");
match(/b*$/, "abbbcbb");
match(/[b\x0a]{2,4}/, "ab\nbbb");
match(/^[b\x0a]{2,8}$/g, "\nb\nbbb");
match(/^[b\x0a]{2,4}$/gm, "ab\nbb\nbbb");
match(/^[b\x0a]{2,8}$/gm, "ab\nbb\nbbb");
