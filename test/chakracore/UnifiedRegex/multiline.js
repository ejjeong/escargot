...
replace(/^a/g, str, "replaced");
replace(/^a/gm, str, "replaced");
replace(/b$/g, str, "replaced");
replace(/b$/gm, str, "replaced");
replace(/^c d$/g, str, "replaced");
replace(/^c d$/gm, str, "replaced");
replace(/^e/g, str, "replaced");
replace(/^e/gm, str, "replaced");
replace(/f$/g, str, "replaced");
replace(/f$/gm, str, "replaced");
