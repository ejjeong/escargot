...
#define NEXT_BYTECODE(ByteCode) \
        ...
        case PushOpcode:
            {
                ...
                if (bytecode->m_value.isInt32()) {
                    literal = ConstantIntIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode->m_value.asInt32());
                    graph->setOperandType(extraData->m_decoupledData->m_targetIndex0, TypeInt32);
                } else if (bytecode->m_value.isDouble()) {
                    literal = ConstantDoubleIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode->m_value.asDouble());
                    graph->setOperandType(extraData->m_decoupledData->m_targetIndex0, TypeDouble);
                } else if (bytecode->m_value.isBoolean()) {
                    literal = ConstantBooleanIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode->m_value.asBoolean());
                    graph->setOperandType(extraData->m_decoupledData->m_targetIndex0, TypeBoolean);
                } else if (bytecode->m_value.isNull() || bytecode->m_value.isUndefined() || bytecode->m_value.isEmpty()) {
                    literal = ConstantESValueIR::create(extraData->m_decoupledData->m_targetIndex0, ESValue::toRawDouble(bytecode->m_value));
                    graph->setOperandType(extraData->m_decoupledData->m_targetIndex0, Type::getType(bytecode->m_value));
        ...
        case PushIntoTempStackOpcode:
            {
                ...
                MoveIR* moveIR = MoveIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
        ...
        case GetByIdOpcode:
            {
                ...
                ESIR* getVarGeneric = GetVarGenericIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode);
        ...
        case GetByIdWithoutExceptionOpcode:
            {
                ...
                ESIR* getVarWithoutException = GetVarGenericWithoutExceptionIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode);
        ...
        case GetByGlobalIndexOpcode:
            {
                ...
                ESIR* getGlobalVarGeneric = GetGlobalVarGenericIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode, bytecode->m_name); // FIXME store only bytecode, get name from that
        ...
        case GetByIndexOpcode:
            {
                ...
                if (bytecode->m_index < codeBlock->m_params.size()) {
                    ESIR* getArgument = GetArgumentIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode->m_index);
                    currentBlock->push(getArgument);
                } else {
                    ESIR* getVar = GetVarIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode->m_index, 0, false);
        ...
        case GetByIndexWithActivationOpcode:
            {
                ...
                ESIR* getVar = GetVarIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode->m_index, bytecode->m_upIndex, true);
                currentBlock->push(getVar);
                bytecode->m_profile.updateProfiledType();
                graph->setOperandType(extraData->m_decoupledData->m_targetIndex0, bytecode->m_profile.getType());
        ...
        case SetByIdOpcode:
            {
                ...
                ESIR* setVarGeneric = SetVarGenericIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode, extraData->m_decoupledData->m_sourceIndexes[0], &bytecode->m_name, bytecode->m_name.string());
        ...
        case SetByIndexOpcode:
            {
                ...
                ESIR* setVar = SetVarIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode->m_index, 0, extraData->m_decoupledData->m_sourceIndexes[0], false);
        ...
        case SetByIndexWithActivationOpcode:
            {
                ...
                ESIR* setVar = SetVarIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode->m_index, bytecode->m_upIndex, extraData->m_decoupledData->m_sourceIndexes[0], true);
                currentBlock->push(setVar);
        ...
        case SetByGlobalIndexOpcode:
            {
                ...
                ESIR* setGlobalVarGeneric = SetGlobalVarGenericIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode, extraData->m_decoupledData->m_sourceIndexes[0], bytecode->m_name);
        ...
        case SetObjectOpcode:
            {
                ...
                ESIR* setObject = SetObjectIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1], extraData->m_decoupledData->m_sourceIndexes[2]);
        ...
        case SetObjectPreComputedCaseOpcode:
            {
                ...
                ESIR* setObject = SetObjectPreComputedIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1], bytecode);
                currentBlock->push(setObject);
        ...
        case EqualOpcode:
            {
                INIT_BYTECODE(Equal);
                ESIR* equalIR = EqualIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case NotEqualOpcode:
            {
                ...
                ESIR* notEqualIR = NotEqualIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case StrictEqualOpcode:
            {
                ...
                ESIR* strictEqualIR = StrictEqualIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case NotStrictEqualOpcode:
            {
                ...
                ESIR* notStrictEqualIR = NotStrictEqualIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case BitwiseAndOpcode:
            {
                ...
                ESIR* bitwiseAndIR = BitwiseAndIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case BitwiseOrOpcode:
            {
                ...
                ESIR* bitwiseOrIR = BitwiseOrIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case BitwiseXorOpcode:
            {
                ...
                ESIR* bitwiseXorIR = BitwiseXorIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case LeftShiftOpcode:
            {
                ...
                ESIR* leftShiftIR = LeftShiftIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case SignedRightShiftOpcode:
            {
                ...
                ESIR* signedRightShiftIR = SignedRightShiftIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case UnsignedRightShiftOpcode:
            {
                ...
                ESIR* unsignedRightShiftIR = UnsignedRightShiftIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case LessThanOpcode:
            {
                ...
                ESIR* lessThanIR = LessThanIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case LessThanOrEqualOpcode:
            {
                ...
                ESIR* lessThanOrEqualIR = LessThanOrEqualIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case GreaterThanOpcode:
            {
                ...
                ESIR* lessThanIR = GreaterThanIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
                currentBlock->push(lessThanIR);
        ...
        case GreaterThanOrEqualOpcode:
            {
                ...
                ESIR* lessThanOrEqualIR = GreaterThanOrEqualIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
                currentBlock->push(lessThanOrEqualIR);
        ...
        case PlusOpcode:
            {
                ...
                INIT_BYTECODE(Plus);
                ESIR* genericPlusIR = GenericPlusIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case MinusOpcode:
            {
                INIT_BYTECODE(Minus);
                ESIR* minusIR = MinusIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case MultiplyOpcode:
            {
                ...
                ESIR* genericMultiplyIR = GenericMultiplyIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case DivisionOpcode:
            {
                ...
                ESIR* genericDivisionIR = GenericDivisionIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case ModOpcode:
            {
                INIT_BYTECODE(Mod);
                ESIR* genericModIR = GenericModIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1]);
        ...
        case BitwiseNotOpcode:
            {
                ...
                ESIR* bitwiseNotIR = BitwiseNotIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
        ...
        case LogicalNotOpcode:
            {
                ...
                ESIR* logicalNotIR = LogicalNotIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
        ...
        case UnaryMinusOpcode:
            {
                ...
                ESIR* UnaryMinusIR = UnaryMinusIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
        ...
        case UnaryTypeOfOpcode:
            {
                ...
                ESIR* typeOfIR = TypeOfIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
        ...
        case ToNumberOpcode:
            {
                ...
                ESIR* toNumberIR = ToNumberIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
        ...
        case IncrementOpcode:
            {
                ...
                ESIR* incrementIR = IncrementIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
        ...
        case DecrementOpcode:
            {
                ...
                ESIR* decrementIR = DecrementIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
        ...
        case CreateObjectOpcode:
            {
                ...
                CreateObjectIR* createObjectIR = CreateObjectIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode->m_keyCount);
        ...
        case CreateArrayOpcode:
            {
                ...
                CreateArrayIR* createArrayIR = CreateArrayIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode->m_keyCount);
                Type t = graph->getOperandType(extraData->m_decoupledData->m_targetIndex0);
        ...
        case InitObjectOpcode:
            {
                ...
                Type objectType = graph->getOperandType(extraData->m_decoupledData->m_sourceIndexes[0]);
                ESIR* initObjectIR;
                if (objectType.isArrayObjectType())
                    initObjectIR = InitArrayObjectIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1], extraData->m_decoupledData->m_sourceIndexes[2]);
                else
                    initObjectIR = InitObjectIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1], extraData->m_decoupledData->m_sourceIndexes[2]);
        ...
        case GetObjectWithPeekingOpcode:
            {
                ...
                if (codeBlock->m_extraData[bytecodeCounter].m_decoupledData->m_registerIncrementCount == 1)
                    graph->setOperandStackPos(extraData->m_decoupledData->m_targetIndex0, codeBlock->m_extraData[bytecodeCounter + 1].m_decoupledData->m_baseRegisterIndex);
                else if (codeBlock->m_extraData[bytecodeCounter].m_decoupledData->m_registerIncrementCount == 2) {
                    currentBlock->push(MoveIR::create(extraData->m_decoupledData->m_targetIndex1, extraData->m_decoupledData->m_sourceIndexes[0]));
                    graph->setOperandStackPos(extraData->m_decoupledData->m_targetIndex0, codeBlock->m_extraData[bytecodeCounter].m_decoupledData->m_baseRegisterIndex);
                    graph->setOperandStackPos(extraData->m_decoupledData->m_targetIndex1, codeBlock->m_extraData[bytecodeCounter + 1].m_decoupledData->m_baseRegisterIndex);
                } else {
        ...
        case CreateFunctionOpcode:
            {
                ...
                CreateFunctionIR* createFunctionIR = CreateFunctionIR::create(extraData->m_decoupledData->m_targetIndex0, bytecode);
        ...
        case CallFunctionOpcode:
            {
                ...
                int calleeIndex = extraData->m_decoupledData->m_sourceIndexes[0];
                int receiverIndex = -1;
                int argumentCount = extraData->m_decoupledData->m_sourceIndexes.size() - 1;
                int* argumentIndexes = (int*) alloca(sizeof(int) * argumentCount);
                for (int i = 0 ; i < argumentCount ; i ++)
                    argumentIndexes[i] = extraData->m_decoupledData->m_sourceIndexes[i + 1];
                CallJSIR* callJSIR = CallJSIR::create(extraData->m_decoupledData->m_targetIndex0, calleeIndex, receiverIndex, argumentCount, argumentIndexes);
        ...
        case CallFunctionWithReceiverOpcode:
            {
                ...
                int calleeIndex = extraData->m_decoupledData->m_sourceIndexes[0];
                int receiverIndex = extraData->m_decoupledData->m_sourceIndexes[1];
                int argumentCount = extraData->m_decoupledData->m_sourceIndexes.size() - 2;
                int* argumentIndexes = (int*) alloca(sizeof(int) * argumentCount);
                for (int i = 0; i < argumentCount; i ++)
                    argumentIndexes[i] = extraData->m_decoupledData->m_sourceIndexes[i + 2];
                CallJSIR* callJSIR = CallJSIR::create(extraData->m_decoupledData->m_targetIndex0, calleeIndex, receiverIndex, argumentCount, argumentIndexes);
                currentBlock->push(callJSIR);
                bytecode->m_profile.updateProfiledType();
                graph->setOperandType(extraData->m_decoupledData->m_targetIndex0, bytecode->m_profile.getType());
        ...
        case NewFunctionCallOpcode:
            {
                ...
                for (int i = 0; i < argumentCount; i++)
                    argumentIndexes[i] = extraData->m_decoupledData->m_sourceIndexes[i + 1];
                CallNewJSIR* callNewJSIR = CallNewJSIR::create(extraData->m_decoupledData->m_targetIndex0, calleeIndex, receiverIndex, argumentCount, argumentIndexes);
        ...
        case CallEvalFunctionOpcode:
            {
                ...
                int argumentCount = extraData->m_decoupledData->m_sourceIndexes.size();
                int* argumentIndexes = (int*) alloca(sizeof(int) * argumentCount);
                for (int i = 0; i < argumentCount; i++)
                    argumentIndexes[i] = extraData->m_decoupledData->m_sourceIndexes[i];
                CallEvalIR* callEvalIR = CallEvalIR::create(extraData->m_decoupledData->m_targetIndex0, argumentCount, argumentIndexes);
        ...
        case ReturnFunctionWithValueOpcode:
            {
                ...
                ReturnWithValueIR* returnWithValueIR = ReturnWithValueIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
        ...
        case JumpOpcode:
            {
                ...
                JumpIR* jumpIR = JumpIR::create(extraData->m_decoupledData->m_targetIndex0, targetBlock);
        ...
        case JumpIfTopOfStackValueIsFalseOpcode:
            {
                ...
                BranchIR* branchIR = BranchIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], trueBlock, falseBlock);
        ...
        case ThrowOpcode:
            {
                INIT_BYTECODE(Throw);
                ThrowIR* throwIR = ThrowIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
        ...
        case AllocPhiOpcode:
            {
                ...
                AllocPhiIR* allocPhiIR = AllocPhiIR::create(extraData->m_decoupledData->m_targetIndex0);
                graph->setOperandStackPos(extraData->m_decoupledData->m_targetIndex0, codeBlock->m_extraData[bytecodeCounter].m_decoupledData->m_baseRegisterIndex);
        ...
        case StorePhiOpcode:
            {
                ...
                StorePhiIR* storePhiIR = StorePhiIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[1], extraData->m_decoupledData->m_sourceIndexes[0]);
                graph->setOperandStackPos(extraData->m_decoupledData->m_targetIndex0, codeBlock->m_extraData[bytecodeCounter].m_decoupledData->m_baseRegisterIndex);
        ...
        case LoadPhiOpcode:
            {
                ...
                LoadPhiIR* loadPhiIR = LoadPhiIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0], extraData->m_decoupledData->m_sourceIndexes[1], extraData->m_decoupledData->m_sourceIndexes[2]);
                graph->setOperandStackPos(extraData->m_decoupledData->m_targetIndex0, codeBlock->m_extraData[bytecodeCounter].m_decoupledData->m_baseRegisterIndex);
        ...
        case ThisOpcode:
            {
                ...
                bytecode->m_profile.updateProfiledType();
                graph->setOperandType(extraData->m_decoupledData->m_targetIndex0, bytecode->m_profile.getType());
                GetThisIR* getThisIR = GetThisIR::create(extraData->m_decoupledData->m_targetIndex0);
        ...
        case EnumerateObjectOpcode:
            {
                ...
                GetEnumerablObjectDataIR* getEnumerablObjectDataIR = GetEnumerablObjectDataIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
        ...
        case CheckIfKeyIsLastOpcode:
            {
                ...
                CheckIfKeyIsLastIR* checkIfKeyIsLastIR = CheckIfKeyIsLastIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
        ...
        case EnumerateObjectKeyOpcode:
            {
                ...
                bytecode->m_profile.updateProfiledType();
                graph->setOperandType(extraData->m_decoupledData->m_targetIndex0, bytecode->m_profile.getType());
                GetEnumerateKeyIR* getEnumerateKeyIR = GetEnumerateKeyIR::create(extraData->m_decoupledData->m_targetIndex0, extraData->m_decoupledData->m_sourceIndexes[0]);
